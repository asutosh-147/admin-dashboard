...
const Notification = () => {
  ...
  return (
    <div className=" nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-4 rounded-lg w-96">
      <div className="flex items-center justify-between py-1 border-b-1">
        <div className="font-medium dark:text-gray-50">Notifications</div>
        <div className="rounded-full p-2 hover:shadow-md text-lg text-gray-500 hover:text-black dark:hover:text-white">
          <MdOutlineCancel onClick={() => handleClose("notification")} />
        </div>
      </div>
      <div className="mt-5">
